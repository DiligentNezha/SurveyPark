				...
				<tbody>
					<s:iterator value="logs" status="st">
						<tr>
							...
							<td>
								<span title='<s:property value="operParams"/>'><s:property value="@io.vicp.goradical.io.vicp.goradical.surveypark.util.StringUtil@getDescString(operParams, 30)"/></span>
							</td>
							<td>
								<span title='<s:property value="operResult"/>'><s:property value="@io.vicp.goradical.io.vicp.goradical.surveypark.util.StringUtil@getDescString(operResult, 30)"/></span>
							</td>
							<td>
								<span title='<s:property value="resultMsg"/>'><s:property value="@io.vicp.goradical.io.vicp.goradical.surveypark.util.StringUtil@getDescString(resultMsg, 30)"/></span>
							</td>
							<td>
